...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/https:/drive.google.com/file/d/1ShN27iGla1HhfsTiVj0pvRmfk2ePy7AW/view";
          },
        },{id: "nav-teaching",
          title: "Teaching",
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%61%69%6C.%69%6E%64%72%61%6E%69%6C%70%61%6C@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/palindrame", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/palindrame", "_blank");
        },
      },{
      id: 'light-theme',
